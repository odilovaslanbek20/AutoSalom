						...
						{chevroletCars?.map(cars => (
							<Link to="/onedetails">
								<div key={cars?.id} className='group cursor-pointer w-full'>
									...
									<h2 className='text-[20px] font-medium font-["Noto Sans"] uppercase leading-[32px] text-[rgba(0,0,0,1)] max-[785px]:text-center w-full'>
										{cars?.name}
									</h2>
									<p className='text-[20px] max-[785px]:text-center font-semibold font-["Noto Sans"] leading-[32px] text-[rgba(0,0,0,1)] max-[490px]:text-center w-full'>
										Narxi:{' '}
										<span className='text-[20px]  font-normal font-["Noto Sans"] leading-[32px] text-[rgba(0,0,0,1)]'>
											{cars?.price}
										</span>
									</p>
